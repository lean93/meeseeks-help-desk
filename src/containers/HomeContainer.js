        ...
        return (
            <Carousel autoplay effect="fade" style={{ marginTop: 30 }}>
                ...
                <Row gutter={8}>
                    ...
                    <Col span={14} style={{ lineHeight: 2, textAlign:'justify',paddingLeft:'10vh', paddingTop:'10vh', paddingRight:'15vh'}}>
                ...
                <Row gutter={8}>
                    <Col span={12} style={{paddingLeft:'15vh', paddingTop:"10vh"}}>
                        <img src={seguimiento} alt="noimage" className="logo-home-seg" />
                    </Col>
                    <Col span={12} style={{ lineHeight: 2, textAlign:'justify', paddingTop:'10vh', paddingRight:'15vh'}}>
                ...
                <Row gutter={8}>
                    <Col span={11} style={{paddingLeft:'15vh', paddingTop:"10vh"}}>
                        <img src={profile} alt="noimage" className="logo-home-profile" />
                    </Col>
                    <Col span={13} style={{ lineHeight: 2, textAlign:'justify',paddingTop:'10vh', paddingRight:'15vh'}}>
